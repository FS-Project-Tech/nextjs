...
export const metadata: Metadata = {
  title: "Nursing | Coming Soon",
  description: "Nursing resources and information – coming soon.",
};
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-16">
      ...
      <p className="text-gray-600 text-center max-w-md mb-8">
        We are preparing dedicated content and resources for nursing professionals. Check back later.
      </p>
      <Link
        href="/shop"
