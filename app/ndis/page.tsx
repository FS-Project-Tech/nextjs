  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-14 md:py-20 bg-white">
        <div className={`container mx-auto ${CONTENT_MAX_W} px-4 sm:px-6`}>
          <h2 className="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-2" style={{ color: NDIS_PRIMARY }}>
            <span className="w-1.5 h-8 rounded-full" style={{ backgroundColor: NDIS_PRIMARY }} aria-hidden />
            NDIS Participants
          </h2>
      ...
      <section className="py-14 md:py-20 bg-gray-100">
        <div className={`container mx-auto ${CONTENT_MAX_W} px-4 sm:px-6 text-center`}>
          ...
          <p className="text-gray-600 mb-10">
            As an <span className="font-bold" style={{ color: NDIS_PRIMARY }}>NDIS Registered Provider</span>, Joya always offers convenient facilities.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {WHY_JOYA.map(({ icon: Icon, text }) => (
              ...
              >
                <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: `${NDIS_PRIMARY}18` }}>
      ...
      >
        <div className={`container mx-auto ${CONTENT_MAX_W} px-4 sm:px-6 text-center`}>
          ...
          <p className="text-white/80 text-sm">
            Joya Medical Supplies - Trusted NDIS Provider
          </p>
        </div>
      </section>
    </div>
