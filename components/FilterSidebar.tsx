...
export default function FilterSidebar({ categorySlug, isMobileDrawer, onClose }: Props) {
  ...
  }, [activeCategory, brandsByCategory]);
  ...
  const handleCategorySelect = useCallback((slug: string) => {
    ...
    onClose?.();
  }, [router, searchParams, onClose, parentBySlug]);
